...
class Student:
	...
	def  getcrs(cls):  # Class Level Method
		cls.crs="PYTHON" # Here crs  called Class Level Data Members
		Student.getcity() # Calling Class Level Method w.r.t Class Name
	@classmethod
	def getcity(cls):
		cls.city="BANG" #  Here city  called Class Level Data Members
